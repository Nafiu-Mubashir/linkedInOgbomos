...
export const Section = ({ type, image, title, content, className, fontSize, id, }) => {
    return (
        <section section className='w-full py-8'>
            {
                // Image on left
                type === 1 &&
                <div className={`${id % 2 === 0 ? 'lg:flex flex-row-reverse' : 'lg:flex'} w-[full] h-[50%] mx-auto gap-10 lg:gap-0`}>

                    <div className="flex justify-center lg:w-[30%] lg:mb-0 mb-4">
                        <img src={image} alt="" />
                    </div>

                    <div className={`${id % 2 === 0 ? 'lg:mx-auto flex justify-end' : ''} lg:w-[70%] lg:my-auto`}>

                        <div className=' lg:w-[80%] m-auto'>

                            <h1 className={`${className} text-[20px] lg:text-[40px] text-primary-purple font-[700] leading-[68.48px] mb-5 drop-shadow-xl text-[#0A66C2]`}>{title}</h1>
                            <p className={`${fontSize} text-sm lg:text-md lg:w-50`}>{content}</p>
...

            {
                ...
                type === 2 &&
                <div className={`${id % 2 === 0 ? 'lg:flex flex-row-reverse' : 'lg:flex justify-center'} w-[full] h-full mx-auto gap-10 lg:gap-0`} >

                    <div className={`${id % 2 === 0 ? 'lg:mx-auto flex justify-end' : ''} lg:w-[50%]`}>

                        <div className=' lg:w-full'>

                            <div className='flex mb-3 gap-4'>
                                <p className='flex justify-center items-center gap-2 lg:mb-5'>
                            ...
                            <p className='flex justify-cente items-center gap-2 lg:mb-5'>
                            ...
                            <Link to=''><span className='text-underline lg:mb-10'>Get directions to the venue here</span></Link>

                            <h1 className={`${className} text-[50px] text-primary-purple leading-[68.48px] mb-5 font-normal`}>{title}</h1>
                            <p className={`${fontSize} text-md lg:w-full lg:mb-0 mb-10`}>{content}</p>
                            {/* <a className='font-bold' href={link} >{linkText}</a> */}
                        </div>

                    </div>
                    <div className="flex justify-cente lg:w-[30%] lg:mb-0 mb-10">
                        <img src={image} alt="" />
                    </div>
